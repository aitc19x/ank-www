...
$translation_japanese = array(
    "lang_code" => "ja",
    "homepage" => "ホームページ",
    "org_name" => "クリスタル日本文化研究グループ",
    "switch_lang" => "言語選択",
    "follow_us" => "フォローする：",
    "copyright" => "Copyright Crystal Nippon Bunka Kenkyu Gurupu All rights reserved.",
    "home" => "ホーム",
    "news" => "ニュース",
    "culture" => "文化",
    "ondemand" => "オンデマンド",
    ...
    "top" => "おすすめ",
    "explore" => "CNKを探索する",
    "meta_description" => "日中交流を促進している日本文化研究グループ",
    "tv" => "テレビ",
    "live" => "ライブ",
    "notice" => "お知らせ",
    "ok" => "はい",
...
$translation_chinese = array(
    "lang_code" => "zh",
    "homepage" => "主页",
    "org_name" => "Crystal 日本文化研究组",
    "switch_lang" => "语言选择",
    "follow_us" => "关注我们：",
    "copyright" => "版权归 Crystal 日本文化研究组所有",
    "home" => "主页",
    "news" => "新闻",
    "culture" => "文化",
    "ondemand" => "点播",
    ...
    "top" => "置顶",
    "explore" => "深入了解 CNK",
    "meta_description" => "一个推动中日交流的日本文化研究学生组织",
    "tv" => "电视",
    "live" => "直播",
    "notice" => "请注意",
    "ok" => "好",
...
$translation_english = array(
    "lang_code" => "en",
    "homepage" => "Homepage",
    "org_name" => "Crystal Nippon Kenkyu",
    "switch_lang" => "Switch language",
    "follow_us" => "Follow us: ",
    "copyright" => "Copyright Crystal Japanese Culture Research Group All rights reserved.",
    "home" => "Home",
    "news" => "News",
    "culture" => "Culture",
    "ondemand" => "On Demand",
    ...
    "top" => "Featured",
    "explore" => "Explore CNK",
    "meta_description" => "An Japanese club prolonging the friendship between China and Japan",
    "tv" => "TV",
    "live" => "Live",
    "notice" => "Notice",
    "ok" => "OK",
